    ...
    return (
        <div className="max-w-6xl mx-auto p-4 sm:p-6 lg:p-8 animate-fade-in">
            <div className="grid grid-cols-1 md:grid-cols-6 md:grid-rows-4 gap-4 h-full min-h-[600px]">
                ...
                <div className="md:col-span-4 md:row-span-2 bg-forest-bg-secondary border border-forest-bg-elevated rounded-3xl p-8 relative overflow-hidden group hover:border-forest-accent-main/30 transition-all duration-500">
                ...
                <div className="md:col-span-2 md:row-span-1 bg-forest-bg-secondary border border-forest-bg-elevated rounded-3xl p-6 flex flex-col justify-center items-center text-center relative overflow-hidden group hover:border-forest-accent-soft/30 transition-all duration-300">
                ...
                <div className="md:col-span-2 md:row-span-1 bg-forest-bg-elevated/30 border border-forest-bg-elevated rounded-3xl p-6 flex items-center justify-around group hover:bg-forest-bg-elevated/50 transition-all duration-300">
                    <a href={`mailto:${resumeData.basics.email}`} className="p-3 bg-forest-bg-secondary rounded-2xl text-forest-text-secondary hover:text-forest-accent-main hover:scale-110 transition-all duration-300 shadow-sm">
                        <Mail size={24} />
                    </a>
                    <a href={resumeData.basics.linkedin} target="_blank" rel="noreferrer" className="p-3 bg-forest-bg-secondary rounded-2xl text-[#0077b5] hover:scale-110 transition-all duration-300 shadow-sm">
                        <Linkedin size={24} />
                    </a>
                    <a href="https://github.com/RayyanDarugar" target="_blank" rel="noreferrer" className="p-3 bg-forest-bg-secondary rounded-2xl text-white hover:scale-110 transition-all duration-300 shadow-sm">
                        <Github size={24} />
                    </a>
                </div>

                {/* 4. About Summary (Medium) - Spans 3 cols, 2 rows */}
                <div className="md:col-span-3 md:row-span-2 bg-forest-bg-secondary border border-forest-bg-elevated rounded-3xl p-8 flex flex-col justify-between hover:border-forest-accent-gold/20 transition-all duration-300">
                    <div>
                ...
                <div className="md:col-span-3 md:row-span-2 bg-gradient-to-br from-forest-bg-secondary to-forest-bg-elevated/20 border border-forest-bg-elevated rounded-3xl p-8 hover:border-forest-accent-soft/30 transition-all duration-300">
